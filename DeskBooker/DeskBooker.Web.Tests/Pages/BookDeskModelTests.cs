...
namespace DeskBooker.Web.Pages
{
  public class BookDeskModelTests
  {
        ...
        public void ShouldReturnExepectedActionResult(Type expectedActionResultType, bool isModelValid, DeskBookingResultCode? deskBookingResultCode)
        {
            //Arrange
            if(!isModelValid)
            {
        ...
        public void ShouldRedirectToBookDeskConfirmationPage()
        {
            ...
            _deskBookingResult.FirstName = "Sam";
